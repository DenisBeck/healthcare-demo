(() => {
    ...
    function initSliders() {
        if (document.querySelector(".skills-page__body")) new core(".skills-page__body", {
            modules: [ Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 3,
        ...
        if (document.querySelector(".reviews-page__body")) new core(".reviews-page__body", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 3,
